...
//	{ battery_remaining, " %s] ", "BAT1"},
	...
	{ cpu_perc, "[ %s%%, ",	 NULL  },
//  { temp,	    " %s°C]",	 "/sys/devices/platform/coretemp.0/hwmon/hwmon4/temp1_input" },
...
//	{ run_command, "[  %s%%] ",   "echo "$(brightnessctl get | awk '{print int(100*($1/255))}')"" },
  { run_command, "[ %d%%] ", "echo $(brightnessctl get | awk '{print int(100*($1/255))}')"},
	{ datetime, "[ %s",           "%F][ %T] "  },
};
